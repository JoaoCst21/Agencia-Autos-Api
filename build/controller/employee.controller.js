...
var EmployeeController = /** @class */ (function (_super) {
    ...
    function EmployeeController() {
        return _super.call(this, "createEmployee(?, ?, ?, ?, ?)", "updateEmployee(?, ?, ?, ?, ?, ?)", "deleteEmployee(?)", "getEmployee(?)", "getAllEmployees()") || this;
    }
    EmployeeController.prototype.procedureParams = function (resource) {
        return [
            resource.name,
            resource.lastName,
            resource.salary,
