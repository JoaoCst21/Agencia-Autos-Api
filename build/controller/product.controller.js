...
var ProductController = /** @class */ (function (_super) {
    ...
    function ProductController() {
        return _super.call(this, "createProduct(?, ?, ?)", "updateProduct(?, ?, ?, ?)", "deleteProduct(?)", "getProduct(?)", "getAllProducts()") || this;
    }
    ProductController.prototype.procedureParams = function (resource) {
